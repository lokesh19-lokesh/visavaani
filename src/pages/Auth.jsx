...
import { GitHub as Github } from '@mui/icons-material';
  ...
  const handleAuth = async (e) => {
    ...
    try {
      if (isLogin) {
        ...
        setMessage('Successfully logged in! (Redirect logic here)');
      } else {
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          ...
          <button onClick={() => setIsLogin(!isLogin)} className="font-medium text-primary hover:text-primary-hover">
            {isLogin ? 'start your immigration journey today' : 'sign in to your existing account'}
          </button>
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-2xl sm:px-10 border border-gray-100">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button onClick={handleGoogleLogin} className="w-full inline-flex justify-center py-2.5 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
