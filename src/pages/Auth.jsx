    ...
    <div className="min-h-[calc(100vh-72px)] bg-[#F8FAFC] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">
          {isRecovery ? 'Update your password' : (isLogin ? 'Sign in to your account' : 'Create your free account')}
        </h2>
        {!isRecovery && (
              ...
              {isLogin && (
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-sm">
                    <button type="button" onClick={handleForgotPassword} className="font-medium text-primary hover:text-primary-hover">Forgot your password?</button>
                  </div>
                </div>
              )}
