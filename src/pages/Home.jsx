...
const destinations = [
  { name: 'United States', code: 'us', image: '/destinations/usa.jpg' },
  { name: 'Canada', code: 'ca', image: '/destinations/canada.jpg' },
  { name: 'United Kingdom', code: 'gb', image: '/destinations/uk.jpg' },
  { name: 'Australia', code: 'au', image: '/destinations/australia.jpg' },
  { name: 'Germany', code: 'de', image: '/destinations/germany.jpg' },
  { name: 'Dubai', code: 'ae', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?auto=format&fit=crop&w=800&q=80' },
  { name: 'Singapore', code: 'sg', image: '/destinations/singapore.jpg' },
  { name: 'Bali', code: 'bali', image: '/destinations/bali.jpg' },
  { name: 'Maldives', code: 'maldives', image: '/destinations/maldives.jpg' },
  { name: 'Sri Lanka', code: 'lk', image: '/destinations/srilanka.jpg' },
  { name: 'Thailand', code: 'th', image: '/destinations/thailand.jpg' },
  { name: 'Japan', code: 'jp', image: '/destinations/japan.jpg' },
  { name: 'China', code: 'cn', image: '/destinations/china.jpg' },
